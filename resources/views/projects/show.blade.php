        ...
        <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
            <dl class="sm:divide-y sm:divide-gray-200">
                ...
                <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">{{ Str::title($project->type) }}</dd>
                </div>
                {{-- Link --}}
                <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                    <dt class="text-sm font-medium text-gray-500">Link</dt>
                    <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                      <a class="text-green-700 hove:text-green-800 hover:cursor-pointer" href="{{ $project->link }}" target="_blank">
                        {{ $project->link }}
                      </a>
                    </dd>
                </div>
                ...
                <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">{{ \Carbon\Carbon::parse($project->start_date)->format('d-m-Y') }}</dd>
                </div>
                {{-- Status --}}
                <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                    <dt class="text-sm font-medium text-gray-500">Status</dt>
                    <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">{{ Str::title($project->status) }}</dd>
                </div>
